...
import com.ecsolutions.service.PRICING_PREFERENTIAL_FEES_Service;
 ...
 */
@RestController
@RequestMapping("/PRICING_PREFERENTIAL_FEES")
public class PRICING_PREFERENTIAL_FEES_Controller {
    @Autowired
    private PRICING_PREFERENTIAL_FEES_Service pRICING_PREFERENTIAL_FEES_Service;

    public PRICING_PREFERENTIAL_FEES_Service getpRICING_PREFERENTIAL_FEES_Service() {
        return pRICING_PREFERENTIAL_FEES_Service;
    }

    @CrossOrigin(origins = "*", maxAge = 3600)
    @RequestMapping(method = RequestMethod.GET, value = "/getValue")
    public DatatableResponse_Entity getPRICING_PREFERENTIAL_FEES(@RequestParam(value="customer_code", defaultValue = "", required = true) String customer_code,
